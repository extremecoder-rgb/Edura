    ...
    <div className='max-w-5xl mx-auto p-6 mt-10 bg-white rounded-lg shadow-md'>
      ...
      <form className='space-y-6' onSubmit={(e)=>e.preventDefault()}>
        ...
        <div>
          ...
          <textarea id="dis" type="text" className='w-full border px-4 py-2 rounded-md h-24 resize-none' placeholder='Course Description' onChange={(e)=>setDescription(e.target.value)} value={description}></textarea>
        </div>
