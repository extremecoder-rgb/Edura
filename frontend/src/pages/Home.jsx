  ...
  return (
    <div className='w-[100%] overflow-hidden'>
      <div className='w-[100%] lg:h-[140vh] h-[70vh] relative'>
        ...
        <div className='absolute lg:top-[30%] top-[75%] md:top-[80%] w-[100%] flex flex-col items-center justify-center gap-3 flex-wrap'>
          ...
          <div className='mt-12 lg:mt-20'> {/* Increased margin-top here */}
            <Logos />
          </div>
        </div>
      </div>
