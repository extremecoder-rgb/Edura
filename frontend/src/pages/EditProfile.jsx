  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-gray-100 px-4 py-10'>
      <div className='bg-white rounded-2xl shadow-lg p-8 max-w-xl w-full relative'>
        <FaArrowLeftLong  className='absolute top-[8%] left-[5%] w-[22px] cursor-pointer'onClick={()=>navigate("/profile")}/>
        ...
        <form action="" className='space-y-5' onSubmit={(e)=>e.preventDefault()}>
          ...
          <div>
            ...
            <input id='name' type="text" name='name' placeholder={userData?.name || ""} className='w-full px-4 py-2 border rounded-md text-sm'
          ...
          <div>
            ...
            <textarea name="description" placeholder='Tell us about yourself' rows={3} className='w-full px-4 py-2 border mt-1 border-gray-300 rounded-md resize-none focus:ring-2 focus:ring-[black]'
